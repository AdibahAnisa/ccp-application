...
import 'package:project/form_bloc/help_center/terminal_form_bloc.dart';
import 'package:project/src/localization/app_localizations.dart';

class TerminalHelpScreen extends StatelessWidget {
  const TerminalHelpScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => TerminalFormBloc(),
      child: Builder(
        builder: (context) {
          final formBloc = context.read<TerminalFormBloc>();
          ...
          return Scaffold(
            ...
            body: FormBlocListener<TerminalFormBloc, String, String>(
