...
import 'package:project/form_bloc/help_center/app_form_bloc.dart';
...
class AppHelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AppFormBloc(),
      child: Builder(
        builder: (context) {
          final formBloc = context.read<AppFormBloc>();
          ...
          return Scaffold(
            ...
            body: FormBlocListener<AppFormBloc, String, String>(
