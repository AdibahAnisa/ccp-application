...
class _TransactionHistoryScreenState extends State<TransactionHistoryScreen> {
  ...
  Future<List<dynamic>> _getTransaction() async {
    var transactionHistory =
        await ProfileResources.getTransactionHistory(prefix: '/transaction/');
    var walletData = await ProfileResources.getTransactionWallet(
        prefix: '/payment/wallet-transaction');
                      ...
                      child: ListTile(
                        title: Text(
                          _walletModel.status == 'SUCCESS'
                              ? '${AppLocalizations.of(context)!.parkingStatus}: ${_walletModel.status}'
